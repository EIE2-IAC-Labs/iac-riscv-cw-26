...
class Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        VlUnpacked<QData/*56:0*/, 64> top__DOT__top_memory__DOT__cache__DOT__cache_array;
        VlUnpacked<QData/*56:0*/, 16> top__DOT__top_memory__DOT__cache__DOT__cache_subarray;
