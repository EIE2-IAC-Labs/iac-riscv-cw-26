...
VL_ATTR_COLD void Vtop_memory___024root__trace_init_sub__TOP__0(Vtop_memory___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+9,"sw", false,-1);
    tracep->declBit(c+10,"sh", false,-1);
    tracep->declBit(c+11,"sb", false,-1);
    tracep->declBit(c+12,"lw", false,-1);
    tracep->declBit(c+13,"lh", false,-1);
    tracep->declBit(c+14,"lb", false,-1);
    tracep->declBit(c+15,"s", false,-1);
    tracep->declBus(c+16,"ALUResult_M", false,-1, 31,0);
    tracep->declBus(c+17,"writeData_M", false,-1, 31,0);
    tracep->declBus(c+18,"readData_M", false,-1, 31,0);
    ...
    tracep->declBus(c+23,"CPU_WORD", false,-1, 31,0);
    tracep->declBus(c+24,"HALF_LEN", false,-1, 31,0);
    tracep->declBus(c+25,"BYTE_LEN", false,-1, 31,0);
    tracep->declBit(c+12,"lw", false,-1);
    tracep->declBit(c+14,"lb", false,-1);
    tracep->declBit(c+13,"lh", false,-1);
    tracep->declBit(c+15,"s", false,-1);
    ...
    tracep->declBus(c+23,"WORD_LENGTH", false,-1, 31,0);
    tracep->declBus(c+24,"HALF_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+23,"ADDRESS_LENGTH", false,-1, 31,0);
    ...
    tracep->declBus(c+19,"d0", false,-1, 7,0);
    tracep->declBus(c+20,"d1", false,-1, 7,0);
    tracep->declBus(c+21,"d2", false,-1, 7,0);
    tracep->declBus(c+22,"d3", false,-1, 7,0);
    tracep->popNamePrefix(2);
}
...
VL_ATTR_COLD void Vtop_memory___024root__trace_full_sub_0(Vtop_memory___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+9,(vlSelf->sw));
    bufp->fullBit(oldp+10,(vlSelf->sh));
    bufp->fullBit(oldp+11,(vlSelf->sb));
    bufp->fullBit(oldp+12,(vlSelf->lw));
    bufp->fullBit(oldp+13,(vlSelf->lh));
    bufp->fullBit(oldp+14,(vlSelf->lb));
    bufp->fullBit(oldp+15,(vlSelf->s));
    bufp->fullIData(oldp+16,(vlSelf->ALUResult_M),32);
    bufp->fullIData(oldp+17,(vlSelf->writeData_M),32);
    bufp->fullIData(oldp+18,(vlSelf->readData_M),32);
    bufp->fullCData(oldp+19,((0xffU & vlSelf->writeData_M)),8);
    bufp->fullCData(oldp+20,((0xffU & (vlSelf->writeData_M 
                                       >> 8U))),8);
    bufp->fullCData(oldp+21,((0xffU & (vlSelf->writeData_M 
                                       >> 0x10U))),8);
    bufp->fullCData(oldp+22,((vlSelf->writeData_M >> 0x18U)),8);
