...
forever():
bfc00018:	0b4000ef          	jal	ra,bfc000cc <display> (File Offset: 0x10cc)
...
bfc000ac:	00160613          	addi	a2,a2,1
bfc000b0:	00680023          	sb	t1,0(a6)
bfc000b4:	fce310e3          	bne	t1,a4,bfc00074 <_loop2> (File Offset: 0x1074)
bfc000b8:	00000013          	addi	zero,zero,0
bfc000bc:	00000013          	addi	zero,zero,0
bfc000c0:	00008067          	jalr	zero,0(ra)
bfc000c4:	00000013          	addi	zero,zero,0
bfc000c8:	00000013          	addi	zero,zero,0

bfc000cc <display> (File Offset: 0x10cc):
display():
bfc000cc:	00000593          	addi	a1,zero,0
bfc000d0:	0ff00613          	addi	a2,zero,255
bfc000d4:	00000013          	addi	zero,zero,0

bfc000d8 <_loop3> (File Offset: 0x10d8):
_loop3():
bfc000d8:	1005c503          	lbu	a0,256(a1) # 10100 <base_data+0x100> (File Offset: 0xffffffff40411100)
bfc000dc:	00158593          	addi	a1,a1,1
bfc000e0:	00000013          	addi	zero,zero,0
bfc000e4:	00000013          	addi	zero,zero,0
bfc000e8:	fec598e3          	bne	a1,a2,bfc000d8 <_loop3> (File Offset: 0x10d8)
bfc000ec:	00000013          	addi	zero,zero,0
bfc000f0:	00000013          	addi	zero,zero,0
bfc000f4:	00008067          	jalr	zero,0(ra)
bfc000f8:	00000013          	addi	zero,zero,0
bfc000fc:	00000013          	addi	zero,zero,0

Disassembly of section .riscv.attributes:

00000000 <.riscv.attributes> (File Offset: 0x1100):
   0:	1e41                	.2byte	0x1e41
   2:	0000                	.2byte	0x0
   4:	7200                	.2byte	0x7200
   6:	7369                	.2byte	0x7369
   8:	01007663          	bgeu	zero,a6,14 <max_count-0xb4> (File Offset: 0x1114)
   c:	0014                	.2byte	0x14
   e:	0000                	.2byte	0x0
