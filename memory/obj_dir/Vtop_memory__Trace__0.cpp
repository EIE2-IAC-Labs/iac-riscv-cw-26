...
void Vtop_memory___024root__trace_chg_sub_0(Vtop_memory___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+8,(vlSelf->sw));
    bufp->chgBit(oldp+9,(vlSelf->sh));
    bufp->chgBit(oldp+10,(vlSelf->sb));
    bufp->chgBit(oldp+11,(vlSelf->lw));
    bufp->chgBit(oldp+12,(vlSelf->lh));
    bufp->chgBit(oldp+13,(vlSelf->lb));
    bufp->chgBit(oldp+14,(vlSelf->s));
    bufp->chgIData(oldp+15,(vlSelf->ALUResult_M),32);
    bufp->chgIData(oldp+16,(vlSelf->writeData_M),32);
    bufp->chgIData(oldp+17,(vlSelf->readData_M),32);
    bufp->chgCData(oldp+18,((0xffU & vlSelf->writeData_M)),8);
    bufp->chgCData(oldp+19,((0xffU & (vlSelf->writeData_M 
                                      >> 8U))),8);
    bufp->chgCData(oldp+20,((0xffU & (vlSelf->writeData_M 
                                      >> 0x10U))),8);
    bufp->chgCData(oldp+21,((vlSelf->writeData_M >> 0x18U)),8);
}
